...
Download the latest DEB version from the [releases](https://github.com/neoslabx/mediasane/releases/) section and use the following command:

```bash
sudo dpkg -i mediasane_*_all.deb
```
